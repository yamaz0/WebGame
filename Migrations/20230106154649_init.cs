        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Players_BodyArmors_ArmorId",
                        column: x => x.ArmorId,
                        principalTable: "BodyArmors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Players_BodyArmors_BootsId",
                        column: x => x.BootsId,
                        principalTable: "BodyArmors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Players_BodyArmors_HelmetId",
                        column: x => x.HelmetId,
                        principalTable: "BodyArmors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Players_BodyArmors_LegsId",
                        column: x => x.LegsId,
                        principalTable: "BodyArmors",
                        principalColumn: "Id");
                    table.ForeignKey(
