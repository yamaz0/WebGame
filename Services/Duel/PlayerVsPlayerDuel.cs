...
{
    public class PlayerVsPlayerDuel : IDuel
    {
        public Entities.Player Player { get; set; }
        public Entities.Player Enemy { get; set; }
        public DuelData Details { get; set; }

        public PlayerVsPlayerDuel(Entities.Player player, Entities.Player enemy)
        {
            Player = player;
            Enemy = enemy;
            DuelData Details = new DuelData();
        }
